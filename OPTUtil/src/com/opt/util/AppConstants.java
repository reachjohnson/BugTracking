...
public class AppConstants
{
   ...
   public static final String DB_JNDI = "java:comp/env/jdbc/TestDB";
   ...
   public static final String[] MAIL_SERVER_IPS = {"101.18.19.241"};
   public static final String EMAIL_SUFFIX = "@testcorp.com";
   ...
   public static final String LEAD_TEAM_DL = "mariajohnson@testcorp.com, ppanigrahy@testcorp.com";
   public static final String MSO_TEAM_DL = "DL-PP-PCE-MSO@test.com";
   ...
   public static final String MAIL_LBL_JIRA_LINK_START = "<a href=\"https://jira.test.com/browse/";
   ...
   public static final String EMAILQ_REMOTE_URL = "remote://emailserver:4447";
