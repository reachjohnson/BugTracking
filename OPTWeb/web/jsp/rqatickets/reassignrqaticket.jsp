    ...
    <script type="text/javascript" language="JavaScript">
        ...
        function reAssignTicket() {
            if (document.OPTForm.formsubmit.value == "submitted") {
                ...
                document.OPTForm.action = "reAssignRQATicket";
                frmWriteSubmit();
            }
        }
        ...
        function displaymessage() {
            ...
            if (varResult == "TICKETREASSIGNED") {
                ...
                jAlert("Bug Re-Assigned Successfully", JavaScriptInfo, function (retval) {
        ...
        <tr>
            <td width="100%" valign="top">
                <table width="100%" align="left">
                    <tr>
                        <td width="100%" class="DarkBlueBandStyleText14">&nbsp;Re-Assign RQA Bug
                        </td>
                    </tr>
                </table>
