    ...
    <script type="text/javascript" language="JavaScript">
        ...
        function closeInternalTicket() {
            if (document.OPTForm.formsubmit.value == "submitted") {
                ...
                document.OPTForm.action = "closeInternalTicket";
                frmWriteSubmit();
            }
        }
        ...
        function displaymessage() {
            ...
            if (varResult == "SUCCESS") {
                ...
                jAlert("Internal Ticket Closed Successfully", JavaScriptInfo, function (retval) {
...
<form name="OPTForm" method="post" action="" enctype="multipart/form-data">
    ...
    <input type="hidden" name="TicketId" value="<%= arlInternalTicketDetails.get(1) %>">
    <input type="hidden" name="TicketDesc" value="<%= arlInternalTicketDetails.get(2) %>">
        ...
        <tr>
            <td width="100%" valign="top">
                <table width="100%" align="left">
                    <tr>
                        <td width="100%" class="DarkBlueBandStyleText14">&nbsp;Close Internal Ticket
                        </td>
                    </tr>
                </table>
                ...
                <table width="100%" cellpadding=0 cellspacing=0 border=0 align="center">
                    <tr>
                        <td width="100%" class="txtgrey">
                            <table width="100%" cellpadding=2 cellspacing=1 border=0 align="center">
                                <tr class="LightBandStyle">
                                    <td width="18%" class="txtgreybold">Final Comments For Closing</td>
                                    <td width="82%">
    ...
    <table cellpadding=2 cellspacing=1 border=0 align="center">
        <tr>
            <td width="50%" align="right" valign="middle">&nbsp;
                <input type="button" class="myButton" value="Save" onclick="JavaScript:closeInternalTicket()"
                       id="buttonId0"/>
            </td>
        ...
        <tr>
            <td width="100%" valign="top">
                ...
                <table width="100%" cellpadding=2 cellspacing=2 border=0>
                    <tr class="LightBandStyle">
                        <td width="80%" class="txtblackbold12">Comments</td>
