...
// codes
var calWidth = 250, calHeight = 250, calOffsetX = -10, calOffsetY = -160;
var calWin = null;
var winX = 0, winY = 0;
var cal = "cal";
var cals = new Array();
...
function showCal(name, dateformat) {
    ...
    if (currentCal != null && currentCal.form != null && currentCal.form[currentCal.field]) {
        ...
        if (!hasCal) {
            if (isIE || isOpera6) {
                calWin = openModalWin1("", calHeight, calWidth, (winX + calOffsetX), (winY + calOffsetY), 'new', 'ModalWindow');
            }
            else {
                calWin = openModalWin1("", calHeight, calWidth, (winX + calOffsetX), (winY + calOffsetY), 'new', 'ModalWindow');
            }
