         ...
         if (AppUtil.isTodayWorkingDay(arlHolidayCalendar))
         {
            ...
            if (arlRQAMailSettings != null && !arlRQAMailSettings.isEmpty())
            {
               ...
               if (strMailToTrigger.equalsIgnoreCase("Y") && strRQACurrentPhase.length() > 0)
               {
                  ...
                  sbMessage.append("test - CSC Managed Services").append("</span>").append(AppConstants.MAIL_LBL_NEXT_LINE);
                  ...
                  sbMessage.append("Email: mariajohnson@test.com | manandaraj@csc.com").append("</span>").append(AppConstants.MAIL_LBL_FONT_END).append(AppConstants.MAIL_LBL_NEXT_LINE);
