...
public class SlidingBarChart
{
   Logger objLogger = Logger.getLogger(BarChart.class.getName());
   int intWidth = 1200;
   int intHeight = 450;

   public String drawSlidingBarChart(String chartName, String userId, String imageRealPath, String chartTitle, String categoryAxisLabel, String valueAxisLabel, ArrayList<Object> arlData) throws Exception
   {
      ...
      try
      {
         ...
         Color lineColor1 = new Color(0, 128, 0);
         Color lineColor2 = new Color(255, 0, 0);
         Color lineColor3 = new Color(0, 0, 255);
         Color lineColor4 = new Color(0, 255, 255);
